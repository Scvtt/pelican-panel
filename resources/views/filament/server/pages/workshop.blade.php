                    ...
                    <div class="flex items-center justify-between mb-5">
                        ...
                        <div class="flex space-x-2 items-center">
                            ...
                            <button
                                ...
                                class="p-2 h-10.5 bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-400 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm focus:border-primary-500 focus:ring focus:ring-primary-500 focus:ring-opacity-50"
