                ...
                <div class="p-6 border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-900">
                    <div class="flex items-center justify-between mb-5">
                        ...
                        <div class="flex space-x-2 items-center">
                            <div class="w-60">
                                <div class="fi-input-wrp flex h-10 rounded-md shadow-sm ring-1 transition duration-75 bg-white dark:bg-gray-800 dark:ring-white/20 focus-within:ring-2 focus-within:ring-primary-500 ring-gray-300 dark:border-gray-700">
                                    ...
                                    <div class="fi-input-wrp-input min-w-0 flex-1">
                                        <input 
                                            class="fi-input block w-full h-10 border-0 py-1.5 text-gray-900 dark:text-white shadow-none ring-0 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6 bg-transparent"
                                            autocomplete="off" 
